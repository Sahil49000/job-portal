...
const JobDescription = () => {
    ...
    const fetchSingleJob = async () => {
        try {
            ...
            if(res.data.success){
                ...
                // setIsApplied(res.data.job.applications.some(application => application.applicant === user?._id)) // update the applied state based on the fetched job data
            }
        }catch (error) {
            console.log(error);
        }
  ...
  console.log("Applications full data:", singleJob?.applications);
